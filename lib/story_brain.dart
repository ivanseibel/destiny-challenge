...
class StoryBrain {
  ...
  String getChoice1() => _storyData[_storyNumber].choice1Text;

  String getChoice2() => _storyData[_storyNumber].choice2Text;

  void nextStory({int choiceNumber}) {
    int nexStory;

    if (choiceNumber == 1) {
      nexStory = _storyData[_storyNumber].choice1NextStory;
    } else {
      nexStory = _storyData[_storyNumber].choice2NextStory;
    }
    _storyNumber = nexStory;
  }
